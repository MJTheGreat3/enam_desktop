document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (state.portfolioSymbols && state.portfolioSymbols.size) {
    setupFilterAndLoad('/api/volume_dev', 'trd', 'AVG_TTL_TRD_QNTY', 'NEW_TTL_TRD_QNTY');
    setupFilterAndLoad('/api/deliv_dev', 'deliv', 'AVG_DELIV_QTY', 'NEW_DELIV_QTY');
  } else {
...
async function setupFilterAndLoad(apiEndpoint, section, avgField, newField) {
  try {
    ...
    console.error(`[ERROR] Failed to fetch ${apiEndpoint}:`, err);
  }
}
